        ...
        <div style="margin-top:30px; display: flex; justify-content: center;">
            <div style="width: 60%;">
                <div style="margin-top:30px;">
                    ...
                    <header class="text-center" style="font-size: 40px; margin-top:30px;"><b>CHUYÊN CẦN</b></header>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <?php 
                                        ...
                                        {
                                            if($row1['Buoi1']==null){echo "Chưa điểm danh";}
                                            else{echo '';}
                                        }
                                    ?>
                                </td>
                                ...
                                <td>
                                    <?php 
                                        ...
                                        {
                                            if($row1['Buoi2']==null){echo "Chưa điểm danh";}
                                            else{echo '';}
                                        }
                                    ?>
                                </td>
                                ...
                                <td>
                                    <?php 
                                        ...
                                        {
                                            if($row1['Buoi3']==null){echo "Chưa điểm danh";}
                                            else{echo '';}
                                        }
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                        ...
                                        {
                                            if($row1['Buoi4']==null){echo "Chưa điểm danh";}
                                            else{echo '';}
                                        }
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                        ...
                                        {
                                            if($row1['Buoi5']==null){echo "Chưa điểm danh";}
                                            else{echo '';}
                                        }
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                        ...
                                        {
                                            if($row1['Buoi6']==null){echo "Chưa điểm danh";}
                                          else{echo '';}
                                        }
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                        ...
                                        {
                                            if($row1['Buoi7']==null){echo "Chưa điểm danh";}
                                            else{echo '';}
                                        }
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                        ...
                                        {
                                            if($row1['Buoi8']==null){echo "Chưa điểm danh";}
                                            else{echo '';}
                                        }
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                        ...
                                        {
                                            if($row1['Buoi9']==null){echo "Chưa điểm danh";}
                                            else{echo '';}
                                        }
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                        ...
                                        {
                                            if($row1['Buoi10']==null){echo "Chưa điểm danh";}
                                            else{echo '';}
                                        }
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                        ...
                                        {
                                            if($row1['Buoi11']==null){echo "Chưa điểm danh";}
                                            else{echo '';}
                                        }
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                        ...
                                        {if($row1['Buoi12']==null){echo "Chưa điểm danh";}
                                        else{echo '';}
                                        }
                                    ?>
                                </td>
