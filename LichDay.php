...
<body>
    <form action="" method="POST">
        ...
        <div style="margin-top:30px; display: flex; justify-content: center;">
            <div style="width: 60%;">
                <div style="">
                    <header class="text-center" style="font-size: 40px;"><b>Lịch dạy</b></header>
                </div>
                            ...
                            <tr class="text-center">
                                <td style="text-align: center">
                                    <b>
                                        <p>
                                            <?php  
                                                $sql44="SELECT * FROM thoigian where MaTG='1'";
